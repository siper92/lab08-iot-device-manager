...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'alert_rules.rules.0.class' => 'string',
            'alert_rules.rules.0.params.min_temperature' => 'string',
            'alert_rules.rules.0.params.max_temperature' => 'string',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'logging.channels.general.driver' => 'string',
            'logging.channels.general.path' => 'string',
            'logging.channels.general.level' => 'string',
            'logging.channels.general.replace_placeholders' => 'boolean',
            'logging.channels.error.driver' => 'string',
            'logging.channels.error.path' => 'string',
            'logging.channels.error.level' => 'string',
            'logging.channels.error.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
...
'alert_rules.rules.0.class','alert_rules.rules.0.params.min_temperature','alert_rules.rules.0.params.max_temperature','app.name','app.env',
...
'app_custom.page_limit','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.general.driver','logging.channels.general.path',
'logging.channels.general.level','logging.channels.general.replace_placeholders','logging.channels.error.driver','logging.channels.error.path','logging.channels.error.level',
'logging.channels.error.replace_placeholders','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'APP_PAGE_LIMIT','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
'PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','JWT_SECRET','JWT_TTL','LOG_CHANNEL',
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','LOG_GENERAL_PATH','LOG_ERROR_PATH',
...
'CACHE_PREFIX','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT',
'KAFKA_BROKERS','KAFKA_CONSUMER_GROUP_ID','KAFKA_QUEUE_TOPIC','ALERT_MIN_TEMPERATURE','ALERT_MAX_TEMPERATURE',
'VITE_APP_NAME',);
